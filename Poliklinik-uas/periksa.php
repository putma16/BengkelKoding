...
if (isset($_GET['aksi']) && $_GET['aksi'] == 'hapus' && isset($_GET['id'])) {
    $id_periksa_hapus = $_GET['id'];

    // Hapus detail obat terlebih dahulu
    $hapus_detail = mysqli_query($mysqli, "DELETE FROM detail_periksa WHERE id_periksa = '$id_periksa_hapus'");

    // Setelah itu, hapus data periksa
    $hapus_periksa = mysqli_query($mysqli, "DELETE FROM periksa WHERE id = '$id_periksa_hapus'");

    if ($hapus_detail && $hapus_periksa) {
        echo "<script> 
    ...
    exit; // tambahkan exit untuk menghentikan eksekusi script setelah penghapusan
}
